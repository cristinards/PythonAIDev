# Desafio - Criando um sistema Bancário Python 💰

Projeto desenvolvido durante a trilha Python no Bootcamp Python AI Backend Developer da Digital Inovation One - DIO.
...
3. **Operação de extrato** :Essa operação deve listar todos os depósitos e saques realizados na conta. No fim da listagem deve ser exibido o saldo atual da conta. Se o extrato estiver em branco, exibir a mensagem: Não foram realizadas movimentações.
